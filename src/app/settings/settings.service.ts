...
export class LookUps {
  static get models() {
    return [
      {label: "Title", description: "Add, Edit and Delete title", name: "title", icon: "fa fa-building orange-text"},
      {label: "Marital Status", description: "Add, Edit and Delete Marital Status", name: "marital_status", icon: "fa fa-male blue-text"},
      {label: "Educational Level", description: "Add, Edit and Delete Educational Level", name: "education_level", icon: "fa fa-handshake-o red-text"},
      {label: "Type", description: "Add, Edit and Delete Type", name: "type", icon: "fa fa-bandcamp teal-text"}
    ];
  }
}
